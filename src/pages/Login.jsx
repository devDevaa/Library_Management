  ...
  return (
    <>
        <div className="w-full max-w-lg mx-auto mt-16">
                ...
                <h1 className='text-2xl font-bold text-center mb-4 text-primary'>Login Here</h1>
                    <div className="mb-4">
                    ...
                    <div className="mb-6">
                        ...
                        <input value={password} onChange={(e) => setPassword(e.target.value)} className="shadow appearance-none borde rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="Enter strong password" />
